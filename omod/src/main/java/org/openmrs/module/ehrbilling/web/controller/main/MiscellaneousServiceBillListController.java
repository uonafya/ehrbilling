...
public class MiscellaneousServiceBillListController {
	...
	public String printBill(@RequestParam("billId") Integer miscellaneousServiceBillId) {
		...
		MiscellaneousServiceBill miscellaneousServiceBill = billingService
		        .getMiscellaneousServiceBillById(miscellaneousServiceBillId);
	...
	public String listBill(@RequestParam(value = "pageSize", required = false) Integer pageSize,
	        ...
	        @RequestParam(value = "serviceId", required = false) Integer serviceId, Model model, HttpServletRequest request) {
		BillingService billingService = (BillingService) Context.getService(BillingService.class);
		...
		model.addAttribute("listBills",
		    billingService.listMiscellaneousServiceBill(pagingUtil.getStartPos(), pagingUtil.getPageSize(), service));
