...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/moduleResources/ehrbilling/scripts/jquery/css/start/jquery-ui-1.8.2.custom.css" />
<link type="text/css" rel="stylesheet"
...
<script type="text/javascript">
	function addToBill(serviceId, name, price) {
		...
		if(document.getElementById("billItem") != null){
     	...
     	+"<input  type='text'  size='5' name='"+serviceId+"_price' id='"+serviceId+"_price' value='"+price+"' onblur='updatePrice("+checkprice+");' />&nbsp;"
		...
		function updatePrice(serviceId, servicePrice, qty){
			var objRegExp  = /^ *[0-9]+ *$/;
			servicePrice=document.getElementById(serviceId+'_price').value;
...
<div id="billDiv">
	<form method="POST" id="billForm"
		action="addMiscellaneousServiceBill.form" onsubmit="return false">
		<div>
