...
<c:if test="${not empty ambulanceBill}">
	<div id="billContainer" style="margin: 10px auto; width: 981px;">
		...
		<table width="100%" border="1">
			<tr>  <!--  Issue 387 --Adjust allignment in table-->
				...
				<tr
					...
					<td><c:choose>
							<c:when
								...
								<a
									href="${pageContext.request.contextPath}/module/ehrbilling/editAmbulanceBill.form?ambulanceBillId=${ambulanceBill.ambulanceBillId}&driverId=${driver.driverId}">Bill
